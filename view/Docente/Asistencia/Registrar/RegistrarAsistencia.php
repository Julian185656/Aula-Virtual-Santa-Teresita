...
<head>
  ...
  <style>
    ...
    /* ✅ BOTÓN VOLVER EN EL HUECO ARRIBA-IZQUIERDA */
    .btn-volver-fixed{
      position: fixed;
      top: 26px;
      left: 26px;
    ...
    .btn-volver-fixed:hover{
      background: rgba(255,255,255,0.25);
      transform: translateY(-1px);
    }

    /* deja espacio arriba para que el botón no estorbe en pantallas pequeñas */
    .page-wrap{
      padding-top: 10px;
    }
    ...
    .filtro-box a:hover{ background:rgba(255,255,255,0.35); }
    ...
    .table tbody tr:hover td{ background:rgba(255,255,255,0.12); color:#fff !important; }
    .table .text-muted{ color:rgba(255,255,255,0.7) !important; }
    ...
    .btn-presente.active{ background:#22c55e; color:#fff; }
    .btn-ausente.active{ background:#ef4444; color:#fff; }
    ...
    @media (max-width: 520px){
      .btn-volver-fixed{ left: 14px; top: 14px; }
      .sticky-actions{ flex-direction: column; align-items: stretch; }
      .sticky-actions .btn-primary{ width: 100%; }
    }
  </style>
</head>
...
<!-- ✅ BOTÓN VOLVER (EN EL LUGAR DE LA CAPTURA) -->
<a href="/Aula-Virtual-Santa-Teresita/view/Home/Home.php" class="btn-volver-fixed">
...
<div class="container page-wrap">
  ...
  <h2>
    ...
    <?php if (!empty($fecha)): ?>
      <span class="badge badge-light text-dark"><?= htmlspecialchars($fecha) ?></span>
    <?php endif; ?>
  </h2>
