...
<section class="section main-banner" id="top" data-section="section1">
    ...
    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modalGestionCursos">Ir</a>
                ...
                <div class="role-card">
                    ...
                    <p>Enviar y consultar notificaciones importantes.</p>
                    <a href="/Aula-Virtual-Santa-Teresita/view/Admin/Notificaciones.php">Ir</a>
                </div>
                <div class="role-card">
                    <i class="fa fa-comments"></i>
                    <h4>Foros</h4>
                    <p>Gestionar y moderar foros de discusión.</p>
       ...
       <div class="role-card">
                ...
                <div class="role-card">
                    ...
                    <h4>Asistencias</h4>
                    <p>Gestiona la asistencia de tus alumnos.</p>
            ...
            <?php elseif ($rolActual === 'Estudiante'): ?>
                ...
                <div class="role-card">
                    ...
                    <p>Contacta soporte vía WhatsApp.</p>
    ...
    <div class="row justify-content-center g-4">
        ...
        <div class="col-md-6 col-lg-3">
            <div class="role-card">
                ...
                <h4>Asistencia</h4>
                <p>Descargar y consultar reportes de asistencia.</p>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="role-card">
                ...
                <h4>Participación</h4>
                <p>Foros, tareas y actividades de los estudiantes.</p>
